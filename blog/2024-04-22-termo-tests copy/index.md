...
description: "Температурные тесты модуля Napi Slot (NAPI-S) под максимальной нагрузкой. Измерение температуры процессора термопарой MAX6675."
keywords: [napi-slot, napi-s, температурные тесты, термопара, max6675, нагрузка, rk3308]
---
