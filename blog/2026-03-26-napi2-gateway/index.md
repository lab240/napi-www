...
>[NAPI2](/docs/computers/napi2) на базе Rockchip RK3568j — это не просто одноплатный компьютер, это полноценный промышленный шлюз. Два гигабитных порта, RS-485 с аппаратным RTS, CAN 2.0 и 4 ГБ RAM делают его идеальной платформой для задач промышленной автоматизации под управлением OpenWRT.
