---
slug: napi2-debian-images
title: Debian для NAPI2 - готовые образы
authors: dmn
tags: [napiworld, napi2, debian, linux]
description: "Готовые образы дистрибутива Debian для NAPI2. Варианты minimal и desktop (Mate/Xfce). Vendor kernel 6.6."
keywords: [napi2, debian, linux, образ, прошивка, rk3568, arm64, desktop, xfce, mate]
---
## Debian на NAPI2

![](img/debian.jpeg)

>Мы рады сообщить, что готовы образы дистрибутива **Debian** для одноплатного компьютера **[NAPI2](/docs/computers/napi2/)**.
...
Debian - один из старейших и наиболее стабильных дистрибутивов Linux. Теперь он доступен для [NAPI2](/docs/computers/napi2/) на базе процессора Rockchip RK3568.
