...
| **На основе [NAPI-C](/docs/napi-intro/)** (**Минпромторг**) | **На основе [NAPI Slot](/docs/soms/napi-slot)** | **На основе [NAPI-C](/docs/napi-intro/)** (**Минпромторг**) | **На основе [NAPI2](/docs/napi2/)** | **На основе Orange CM4** |
...
- [NAPI-C](/docs/napi-intro/) - компактный промышленный контроллер на RK3308
