...
image: ../napi-c/banners/banner-napi-c1.jpeg
---
...
![Таблица GPIO NAPI](img/gpio_11123-3.jpg)
...
![Функциональная схема NAPI](img/scheme1.png)
...
| Платформа | Описание |
|---|---|
| [NAPI-Slot](/docs/soms/napi-slot) | Модуль со слотом под стандартные интерфейсные карты |
| [Платы для NAPI-Slot](/docs/boards/napi-slot/) | Устройства на основе NAPI-Slot |
| [NAPI2](/docs/computers/napi2/) | Новый одноплатный компьютер на RK3568 с HDMI и CAN |
