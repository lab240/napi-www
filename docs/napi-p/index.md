---
sidebar_position: 3
title:  "* Одноплатный компьютер NAPI-P"
...
NAPI-P — одноплатный процессорный модуль на основе мощного ARM процессора Rockchip RK3308 под управлением ОС Linux. Модуль является модификацией модуля NAPI-C, где заменены интерфейсы Ethernet,USB на PINS с шагом 2.4

![alt text](img/napi-p-1.jpeg)
...
![alt text](img/napi-p-carrier1.jpeg)
