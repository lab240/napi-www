...
- [Одноплатники NAPI-C и NAPI-P](/docs/napi-intro) - компактные одноплатные компьютеры на RK3308
- [Одноплатный компьютер NAPI2](/docs/napi2) - новый одноплатник серии NAPI
