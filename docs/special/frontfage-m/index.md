...
:::warning Программно аппаратный комплекс (ПАК) - Сборщик-М
...
В ПАК уже установлен и преднастроен софт:

- NapiLinux & NapiConfig
- шлюз mbusd
- комбайн данных telegraf
- база данных influxdb2

Все программное обеспечение предоставляется в открытых кодах и бесплатно. 
:::
