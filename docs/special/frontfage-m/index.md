...
:::caution  Сборщик-М - программно аппаратный комплекс (ПАК)
 
Представляем первый программно-аппаратный комплекс на основе [Сборщик-Компакт](/docs/computers/frontcontrol-compact/) и [NapiLinux](http://napilinux.ru) - 
...
2. Сборщик-М транслирует запросы из Modus TCP в ModBus RTU;
3. Сборщик-М опрашивает устройства по Modbus RTU, получает ответ в Modbus RTU;
4. Сборщик-М транслирует ответы в Modbus TCP. 
...
![](img/test-dl-303-ok.jpg)

Ошибка

![](img/test-dl-303-fail.jpg)
