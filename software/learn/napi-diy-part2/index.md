...
[Скачать и записать](/recipes/armbian-tuning#скачайте-образ-по-ссылке) на SD образ ARMbian -->

- [Доставить нужные пакеты](/recipes/armbian-tuning#проводим-тюнинг-armbian)
...
В Linux есть пакет gpiod для работы с GPIO, мы будем применять его. Но (!!!) для корректного чтения GPIO нам понадобиться свежая версия. Для ARMbian мы написали [статью](/software/sensors/gpiod/), как установить свежую версию из исходников (так как в пакете довольно старая версия).
