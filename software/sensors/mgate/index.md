...
В сборке NapiLinux и в подготовленном ARMbian этот пакет уже установлен, если необходимо установить пакет самостоятельно, это можно сделать по [нашей инструкции](/recipes/armbian-tuning#скомпилируем-mbusd).
