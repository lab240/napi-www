...
Написал "на коленке" полезный сниффер для анализа Modbus RTU трафика, который декодирует и отображает пакеты в удобном формате.
...
Скрипт читает и распознает пакеты Modbus, транслируя запросы на экран в удобном для анализа формате.