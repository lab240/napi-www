...
telegram_id: 16
description: "Диагностика SD-NAND карт в Linux: получение регистров CID/CSD, устранение проблем инициализации в ядре 6.x. Разбор на картах Zetta."
keywords: [sd-nand, linux, диагностика, ядро, zetta, mmc, kernel, rk3308]
---
