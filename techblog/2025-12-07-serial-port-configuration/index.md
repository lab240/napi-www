...
telegram_id: 32
description: "Настройка параметров последовательного порта в Linux через stty: скорость, биты данных, чётность, стоп-биты."
keywords: [uart, serial, stty, linux, последовательный порт, настройка, rs485]
---
